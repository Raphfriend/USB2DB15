...
#define VID_8BITDO_M30          0x057E // 8BitDo M30
...
#define PID_DAEMON_MD           0x8031 // DaemonBite Retro Controllers Megadrive (Modded PID to suit the USB2DB15, check COMPATIBILITY.md)
